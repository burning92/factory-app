  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] md:min-h-0 p-4 md:p-6 max-w-2xl mx-auto pb-20 md:pb-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-slate-200 font-medium">냉장·냉동 온도 및 위생 점검일지</span>
      </div>

      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <h1 className="text-lg font-semibold text-slate-100">냉장·냉동 온도 및 위생 점검일지 — 목록</h1>
        <Link
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          window.location.href = `/daily/cold-storage-hygiene/${log.id}/edit`;
                        }}
