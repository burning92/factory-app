...
function statusBadgeClass(s: HygieneLogStatus): string {
  switch (s) {
    case "approved": return "bg-emerald-900/50 text-emerald-300";
    case "submitted": return "bg-cyan-900/50 text-cyan-300 border border-cyan-600/50";
    case "rejected": return "bg-amber-900/50 text-amber-300";
    default: return "bg-slate-700/80 text-slate-400";
  }
}
                  ...
                  <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          window.location.href = `/daily/hygiene/${log.id}/edit`;
                        }}
